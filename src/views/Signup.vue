<template>
  <div class="max-w-sm m-auto my-8">
      <v-form class="form" @submit.prevent="signup">
          <v-text-field v-model="email" dense label="E-mail Address" placeholder="andy@web-crunch.com"></v-text-field>
          <v-text-field v-model="password" dense label="Password" placeholder="Password"></v-text-field>
          <v-text-field v-model="password_confirmation" dense label="Password Confirmation" placeholder="Password confirmation"></v-text-field>
